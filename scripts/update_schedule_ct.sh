#!/bin/bash
# Update the Cloud Scheduler job to run at 8 AM CT on weekdays only

export PATH="$HOME/google-cloud-sdk/bin:$PATH"
PROJECT_ID="slack-ai-news-feed"

echo "📅 Updating schedule to 8 AM CT on weekdays..."
...
gcloud scheduler jobs create pubsub ai-news-daily \
    ...
    --location=us-central1 \
    --project="$PROJECT_ID" \
    --description="AI News Digest - Weekdays at 8 AM CT"

echo "✅ Schedule updated!"
echo ""
echo "New schedule: Monday-Friday at 8:00 AM Central Time"
